  ...
  return (
    <div className={styles.container} >
      <div data-testid="dropzone"  {...getRootProps({ className: styles.dropzone })}>
        ...
        {(options?.maxSize ?? 0 > 0) && <small className={cx(styles.small, styles.acceptContainer)}>
          {`Max file size: ${formattedSize}`}
        </small>}
...
function getAcceptedFileTypeText(accept: string | string[] | Accept, acceptString?: string) {
